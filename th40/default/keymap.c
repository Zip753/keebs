...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_tkl_ansi(
        KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,    KC_L,    KC_U,    KC_Y,    S(KC_SCLN), KC_BSPC,
    ...
    // same as layer 0, but with some bailout options:
    // - shifts in their regular positions
    // - / in on the middle key
    [1] = LAYOUT_tkl_ansi(
    ...
    [2] = LAYOUT_tkl_ansi(
        KC_ESC,  S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8), KC_NUBS, S(KC_NUBS), KC_SCLN,
        KC_LCTL, KC_LBRC, KC_RBRC, S(KC_BSLS), S(KC_MINS), KC_NO, S(KC_EQL), KC_EQL, S(KC_9), S(KC_0),       KC_QUOT,
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_SCLN, KC_NO,   KC_NO,   KC_NO,   KC_MINS, S(KC_LBRC), S(KC_RBRC), KC_RSFT,
